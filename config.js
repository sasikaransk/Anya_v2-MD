...
module.exports = {
     ...
     */
    ownername: process.env.Owner_Name || "Sasi",
    ownernumber: process.env.Owner_Number || "94719695046",
    instagramId: process.env.Insta || "3.69_pika",

    /**
     * other details and parameters
     */
    author: process.env.Author || "JPS 🌚🌙",
    ...
    sessionId: process.env.SESSION_ID || "PWMC9_A_N_Y_A_V_2_W5oFRlDllWnrkAe",
